...
class Board:
    def __init__(self):
        ...
        for row in self.obj.cre:
            self.cre_list.append(self.sett.main_menu.render(row[2], False, ('silver')).get_rect(center = (650, 350)))
        self.cre_run = 0
        self.snd_hurt = False
    ...
    def _draw_main_menu(self):
        ...
        if(self.obj.menu == 1):
            if(self.obj.quit):
                self.sett.screen.blit(self.sett.main_menu.render("Ở lại đi mà", False, ('silver')), (11 * 50, 4 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Ô kê", False, ('silver')), (10 * 50, 7 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Khồng", False, ('silver')), (15 * 50, 7 * 50))
                ...
                self.sett.screen.blit(self.sett.main_menu.render("Game mới", False, ('silver')), (11 * 50, 5 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Chọn màn", False, ('silver')), (11 * 50, 6 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Hướng dẫn", False, ('silver')), (11 * 50, 7 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Credit", False, ('silver')), (11 * 50, 8 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Minigame Tết", False, ('silver')), (11 * 50, 9 * 50))
                self.sett.screen.blit(self.sett.main_menu.render("Thoát", False, ('silver')), (11 * 50, 10 * 50))
                self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để chọn", False, ('silver')), (11.5 * 50, 12 * 50))
                self.sett.screen.blit(self.sett.player, (self.obj.player_pos[1] * 50, self.obj.player_pos[0] * 50))
                self.sett.screen.blit(self.sett.title_1.render("S", False, ('silver')), (10 * 50, 0 * 50))
                self.sett.screen.blit(self.sett.title_2.render("Ú", False, ('silver')), (11.85 * 50, 0.75 * 50))
                self.sett.screen.blit(self.sett.title_2.render("talkẻ", False, ('silver')), (11.85 * 50, 2 * 50))
        elif(self.obj.menu == 2):
            for pos in self.sett.lvl_frame_list:
                self.sett.screen.blit(self.sett.lvl_frame, (pos[0] * 50, pos[1] * 50))
                self.sett.screen.blit(self.sett.main_menu.render(str(pos[2]), False, ('silver')), ((pos[0] + 0.82) * 50, (pos[1] + 2) * 50))
                if(not self.obj.level_list[pos[2]-1]):
                    self.sett.screen.blit(self.sett.lvl_lock, ((pos[0] + 0.5) * 50, (pos[1] + 0.5) * 50))
            self.sett.screen.blit(self.sett.player, (self.obj.player_pos[1] * 50, self.obj.player_pos[0] * 50))
            self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để chọn, ESC để quay lại", False, ('silver')), (10.5 * 50, 12 * 50))
        elif(self.obj.menu == 3):
            self.sett.screen.blit(self.sett.tutorial.render("Phím mũi tên để di chuyển", False, ('silver')), (2 * 50, 2 * 50))
            self.sett.screen.blit(self.sett.arrow, (2.5 * 50, 2.5 * 50))
            self.sett.screen.blit(self.sett.tutorial.render("Giải cứu sú pónk để qua màn", False, ('silver')), (9 * 50, 2 * 50))
            self.sett.screen.blit(pygame.transform.scale(self.sett.goal, (100, 100)), (11.5 * 50, 3.5 * 50))
            self.sett.screen.blit(self.sett.tutorial.render("Dồn Người Xương vào Đá", False, ('silver')), (17 * 50, 2 * 50))
            self.sett.screen.blit(self.sett.tutorial.render("hoặc Tường để tiêu diệt", False, ('silver')), (17 * 50, 3 * 50))
            ...
            self.sett.screen.blit(self.sett.tutorial.render("Nhặt dao để chém đối thủ", False, ('silver')), (6.5 * 50, 8 * 50))
            self.sett.screen.blit(pygame.transform.scale(self.sett.key, (75, 75)), (7 * 50, 9 * 50))
            self.sett.screen.blit(pygame.transform.scale(self.sett.lock, (75, 75)), (10 * 50, 9 * 50))
            self.sett.screen.blit(self.sett.tutorial.render("Cẩn thận hố gai", False, ('silver')), (15 * 50, 8 * 50))
            self.sett.screen.blit(pygame.transform.scale(self.sett.spike, (75, 75)), (16 * 50, 9 * 50))
            self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để tiếp tục", False, ('silver')), (11.5 * 50, 12 * 50))
        elif(self.obj.menu == 4):
            for row in self.obj.cre:
                self.sett.screen.blit(self.sett.main_menu.render(row[2], False, ('silver')), (self.cre_list[row[0]].x, (row[1] - self.cre_run) * 50))
            self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để tiếp tục", False, ('silver')), (11.5 * 50, 12 * 50))
            self.cre_run += 0.02
        elif(self.obj.menu == 5): #minigame
            self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để quay lại", False, ('silver')), (11.5 * 50, 12 * 50))
            self.sett.screen.blit(self.sett.tutorial.render("Time: ", False, ('silver')), (16 * 50, 11.85 * 50))
            self.sett.screen.blit(self.sett.tutorial.render(str(self.obj.event_time_now), False, ('silver')), (17.6 * 50, 11.85 * 50))
            if(self.obj.event_lose):
                self.sett.screen.blit(self.sett.minigame.render("Tết này bạn đã", False, ('silver')), (3 * 50, 4 * 50))
                self.sett.screen.blit(self.sett.minigame.render(f"{self.sett.event_list[self.obj.event_lose_by]}", False, ('silver')), (3 * 50, 7 * 50))
            else:
    ...
    def event(self):
        for i in range (0, random.randint(1, int(self.obj.event_spawn)+3)):
            ...
            new_spawn = self.sett.main_menu_2.render(f"{self.sett.event_list[event]}", False, ('silver')).get_rect(topleft = self.spawn)
    ...
    def _draw_board(self):
        if(self.obj.moves <= 0):
            if(self.obj.secret):
                ...
                self.sett.screen.blit(self.sett.tutorial.render("R để chơi lại", False, ('silver')), (11.5 * 50, 11 * 50))
            else:
            ...
            self.sett.screen.blit(self.sett.tutorial.render("SPACE để tiếp tục", False, ('silver')), (11.5 * 50, 11 * 50))
        elif(self.obj.final):
            self.sett.screen.blit(self.sett.background, (0, 0))
            ...
            self.sett.screen.blit(self.sett.main_menu.render(str(self.obj.fscript_0[self.obj.final_score]), False, ('silver')), (5 * 50, 8.5 * 50))
            self.sett.screen.blit(self.sett.tutorial.render(str(self.obj.fscript_1[self.obj.final_score]), False, ('silver')), (7 * 50, 10 * 50 + 15))
            self.sett.screen.blit(self.sett.tutorial.render(str(self.obj.fscript_2[self.obj.final_score]), False, ('silver')), (7 * 50, 11 * 50 + 15))
            self.sett.screen.blit(self.sett.main_menu_2.render("SPACE để tiếp tục", False, ('silver')), (11.5 * 50, 13 * 50))
            ...
            if(self.obj.moves > 9):
                self.sett.screen.blit(self.sett.ingame.render(str(self.obj.moves), False, ('silver')), (1.3 * 50, 9.5 * 50))
            else:
                self.sett.screen.blit(self.sett.ingame.render(str(self.obj.moves), False, ('silver')), (2 * 50, 9.5 * 50))
            if(self.obj.level < 10):
                self.sett.screen.blit(self.sett.ingame.render(str(self.obj.level), False, ('silver')), (23 * 50, 9.5 * 50))
            else:
                self.sett.screen.blit(self.sett.ingame.render(str(self.obj.level), False, ('silver')), (22.5 * 50, 9.5 * 50))
        ...
        if self.obj.final:
            ...
            if(touch_goal):
                ...
                if(self.obj.level != 8):
                    ...
                    pygame.mixer.music.load('assets/soundtracks/normal.mp3')
                    pygame.mixer.music.play(loops = -1, fade_ms = 3000)
                    ...
                    if(self.obj.level == 0):
                        ...
                        if((event.key in self.sett.KEY_DIR) and (not self.obj.hurt) and (not self.obj.walk) and (self.obj.player_pos != self.obj.player_kill_pos) and (self.obj.player_pos != self.obj.player_touch_pos)):
                            ...
                            if(self.obj.final_score in self.obj.ending):
                                ...
                                if(self.obj.final_score in [7, 9, 10, 15, 17]):
                                    pygame.mixer.music.stop()
                                    pygame.mixer.music.unload()
                                if(self.obj.final_score == 18 or self.obj.final_score == 8):
                                    self.sett.snd_demon.play()
                                elif(self.obj.final_score == 19 or self.obj.final_score == 9):
                                    self.sett.snd_gun.play()
                                elif(self.obj.final_score == 5):
                                    pygame.mixer.music.load('assets/soundtracks/reveal.mp3')
                                    pygame.mixer.music.play(loops = -1)
            if(self.obj.level == 0):
